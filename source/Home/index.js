...
export default function Home({ navigation }) {
    ...
    const fetchServicios = async () => {
      ...
      try {
        ...
        if (res.ok) {
          ...
          // Mezclar y tomar 6 servicios aleatorios
  ...
  // Componente para mostrar el logo del servicio
  ...
  // Renderiza los servicios en dos filas de 3
  const renderServiciosRecomendados = () => {
    ...
    return filas.map((fila, idx) => (
      <View style={styles.filaServicios} key={idx}>
        ...
        {/* Si la fila tiene menos de 3, rellena con espacios vacíos */}
        {fila.length < 3 &&
    ...
    <View style={styles.todo}>
      ...
      <View style={styles.container}>
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          {/* Servicios recomendados dinámicos */}
          {loadingServicios ? (
